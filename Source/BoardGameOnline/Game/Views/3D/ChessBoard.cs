...
{
    class ChessBoard : ModelVisual3D
    {
        private MeshGeometry3D mesh;
        private GeometryModel3D material;

        protected GeometryModel3D Material
        {
            get { return material; }
            set { material = value; }
        }
        ...
        public Color SquaresColor
        {
            set
            {
                ((DiffuseMaterial)((GeometryModel3D)this.Content).Material).Color = (Color)value;
            }
        }
